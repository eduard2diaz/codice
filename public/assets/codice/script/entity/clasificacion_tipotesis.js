var clasificacion_tipotesis = function () {
    var table = null;
    var obj = null;

    var configurarDataTable = function () {
        table = $('table#clasificacion_tipotesis_table').DataTable({
    ...
    var configurarFormulario = function () {
        $("div#basicmodal form").validate({
            rules:{
                'clasificacion_tipotesis[nombre]': {required:true}
            }
        })
    }
    ...
    var refrescar = function () {
        $('a#clasificacion_tipotesis_tablerefrescar').click(function (evento)
        {
            evento.preventDefault();
    ...
    var newAction = function () {
        $('div#basicmodal').on('submit', 'form#clasificacion_tipotesis_new', function (evento)
        {
            evento.preventDefault();
    ...
    var edicionAction = function () {
        $('div#basicmodal').on('submit', 'form#clasificacion_tipotesis_edit', function (evento)
        {
            evento.preventDefault();
            var padre = $(this).parent();
            var l = Ladda.create(document.querySelector( '.ladda-button' ) );
    ...
    var eliminar = function () {
        $('table#clasificacion_tipotesis_table').on('click', 'a.eliminar_clasificacion_tipotesis', function (evento)
        {
            evento.preventDefault();
            var obj = $(this);
            var link = $(this).attr('data-href');
