var tipo_premio = function () {
    var table = null;
    var obj = null;

    var configurarDataTable = function () {
        table = $('table#tipo_premio_table').DataTable({
    ...
    var refrescar = function () {
        $('a#tipo_premio_tablerefrescar').click(function (evento)
        {
            evento.preventDefault();
            ...
            $.ajax({
                ...
                success: function (data) {
                    $('table#tipo_premio_tabletable').html(data);
                    table.destroy();
                    configurarDataTable();
                },
                error: function ()
    ...
    var newAction = function () {
        $('div#basicmodal').on('submit', 'form#tipo_premio_new', function (evento)
        {
            evento.preventDefault();
                    ...
                    else
                    {
                        ...
                        objeto = table.row.add({
                            ...
                            "acciones": "<ul class='m-nav m-nav--inline m--pull-right'>" +
                                ...
                                "<li class='m-nav__item'>" +
                                "<a class='btn btn-danger btn-sm  eliminar_tipo_premio' data-href=" + Routing.generate('tipo_premio_delete',{id:data['id']}) + ">" +
    ...
    var edicionAction = function () {
        $('div#basicmodal').on('submit', 'form#tipo_premio_edit', function (evento)
        {
            evento.preventDefault();
            var padre = $(this).parent();
            var l = Ladda.create(document.querySelector( '.ladda-button' ) );
