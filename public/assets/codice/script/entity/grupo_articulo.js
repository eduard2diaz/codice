var grupo_articulo = function () {
    var table = null;
    var obj = null;

    var configurarDataTable = function () {
        table = $('table#grupo_articulo_table').DataTable({
    ...
    var refrescar = function () {
        $('a#grupo_articulo_tablerefrescar').click(function (evento)
        {
            evento.preventDefault();
    ...
    var newAction = function () {
        $('div#basicmodal').on('submit', 'form#grupo_articulo_new', function (evento)
        {
            evento.preventDefault();
                    ...
                    else
                    {
                        ...
                        objeto = table.row.add({
                            ...
                            "acciones": "<ul class='m-nav m-nav--inline m--pull-right'>" +
                                ...
                                "<li class='m-nav__item'>" +
                                "<a class='btn btn-danger btn-sm  eliminar_grupo_articulo' data-href=" + Routing.generate('grupo_articulo_delete',{id:data['id']}) + ">" +
    ...
    var edicionAction = function () {
        $('div#basicmodal').on('submit', 'form#grupo_articulo_edit', function (evento)
        {
            evento.preventDefault();
            var padre = $(this).parent();
            var l = Ladda.create(document.querySelector( '.ladda-button' ) );
