var organizador = function () {
    var table = null;
    var obj = null;

    var configurarDataTable = function () {
        table = $('table#organizador_table').DataTable({
    ...
    var refrescar = function () {
        $('a#organizador_tablerefrescar').click(function (evento)
        {
            evento.preventDefault();
    ...
    var newAction = function () {
        $('div#basicmodal').on('submit', 'form#organizador_new', function (evento)
        {
            evento.preventDefault();
    ...
    var edicionAction = function () {
        $('div#basicmodal').on('submit', 'form#organizador_edit', function (evento)
        {
            evento.preventDefault();
            var padre = $(this).parent();
            var l = Ladda.create(document.querySelector( '.ladda-button' ) );
