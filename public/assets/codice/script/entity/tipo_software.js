var tipo_software = function () {
    var table = null;
    var obj = null;

    var configurarDataTable = function () {
        table = $('table#tipo_software_table').DataTable({
    ...
    var configurarFormulario = function () {
        ...
        $("div#basicmodal form").validate({
            rules:{
                'tipo_software[nombre]': {required:true}
            }
        })
    }
    ...
    var refrescar = function () {
        $('a#tipo_software_tablerefrescar').click(function (evento)
        {
            evento.preventDefault();
    ...
    var newAction = function () {
        $('div#basicmodal').on('submit', 'form#tipo_software_new', function (evento)
        {
            evento.preventDefault();
                    ...
                    else
                    {
                        ...
                        objeto = table.row.add({
                            ...
                            "acciones": "<ul class='m-nav m-nav--inline m--pull-right'>" +
                                ...
                                "<li class='m-nav__item'>" +
                                "<a class='btn btn-danger btn-sm  eliminar_tipo_software' data-href=" + Routing.generate('tipo_software_delete',{id:data['id']}) + ">" +
    ...
    var edicionAction = function () {
        $('div#basicmodal').on('submit', 'form#tipo_software_edit', function (evento)
        {
            evento.preventDefault();
            var padre = $(this).parent();
            var l = Ladda.create(document.querySelector( '.ladda-button' ) );
