var institucion = function () {
    ...
    var configurarFormulario = function () {
        $('select#institucion_pais').select2({
        ...
        $("div#basicmodal form").validate({
            rules:{
                ...
                'institucion[pais]': {required:true},
                'institucion[ministerio]': {required:true}
            }
        })
    }
    ...
    var refrescar = function () {
        $('a#institucion_tablerefrescar').click(function (evento)
        {
            evento.preventDefault();
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    else
                    {
                        ...
                        obj.parents('tr').children('td:nth-child(4)').html(data['ministerio']);
                    }
                },
                error: function ()
                {
    ...
    var paisListener = function () {
        $('div#basicmodal').on('change', 'select#institucion_pais', function (evento)
        {
            if ($(this).val() > 0)
                $.ajax({
                    ...
                    beforeSend: function (data) {
                        mApp.block("div#basicmodal div.modal-body",
                            {overlayColor:"#000000",type:"loader",state:"success",message:"Cargando ministerios..."});
                    },
                    success: function (data) {
                        var cadena="";
                        ...
                        $('select#institucion_ministerio').html(cadena);
                    },
                    error: function () {
                        base.Error();
                    },
