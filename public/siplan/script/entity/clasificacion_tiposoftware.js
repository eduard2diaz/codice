var clasificacion_tiposoftware = function () {
    var table = null;
    var obj = null;

    var configurarDataTable = function () {
        table = $('table#clasificacion_tiposoftware_table').DataTable({
    ...
    var refrescar = function () {
        $('a#clasificacion_tiposoftware_tablerefrescar').click(function (evento)
        {
            evento.preventDefault();
    ...
    var newAction = function () {
        $('div#basicmodal').on('submit', 'form#clasificacion_tiposoftware_new', function (evento)
        {
            evento.preventDefault();
                    ...
                    else
                    {
                        ...
                        objeto = table.row.add({
                            ...
                            "acciones": "<ul class='m-nav m-nav--inline m--pull-right'>" +
                                ...
                                "<li class='m-nav__item'>" +
                                "<a class='btn btn-danger btn-sm  eliminar_clasificacion_tiposoftware' data-href=" + Routing.generate('clasificacion_tiposoftware_delete',{id:data['id']}) + ">" +
    ...
    var edicionAction = function () {
        $('div#basicmodal').on('submit', 'form#clasificacion_tiposoftware_edit', function (evento)
        {
            evento.preventDefault();
            var padre = $(this).parent();
            var l = Ladda.create(document.querySelector( '.ladda-button' ) );
    ...
    var eliminar = function () {
        $('table#clasificacion_tiposoftware_table').on('click', 'a.eliminar_clasificacion_tiposoftware', function (evento)
        {
            ...
            bootbox.confirm({
                ...
                message: '¿Está seguro que desea eliminar este clasificación?',
                buttons: {
                    confirm: {
