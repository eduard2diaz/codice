 ...
 * @author eduardo
 */
class AddAutorInstitucionFieldSubscriber  implements EventSubscriberInterface{
    ...
    public function preSetData(FormEvent $event) {
        ...
        $form = $event->getForm();
       if(null==$data->getId()){
           $form->add('institucion',null,array('label'=>'Centro de trabajo','required'=>true,'choices'=>array()));
        }else
       {
           $ministerio= is_array($data) ? $data['ministerio'] : $data->getMinisterio();
           $this->addElements($event->getForm(), $ministerio);
